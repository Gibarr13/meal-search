...
<template>
  <div class="p-8 pb-0 text-orange-500">
        <h1 class="text-4xl font-bold mb-4">Searched Meals By Ingredients</h1>
     </div>
     ...
     <!-- {{  ingredients }} -->
        ...
        <div class="p-10">
            <input type="text" v-model="keyword" class="rounded border-2 border-gray-200 w-full bg-white mb-5" placehoder="Enter ingredient name" />
